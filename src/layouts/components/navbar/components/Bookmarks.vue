<template>
    <div class="navbar-bookmarks flex items-center">
                    ...
                    <ul class="vx-navbar__starred-pages-more--list">
                        <draggable v-model="starredPagesMore" :group="{name: 'pinList'}" class="cursor-move">
                            <li class="starred-page--more flex items-center cursor-pointer"
                                ...
                                <feather-icon class="ml-2 mr-1" :icon="page.icon"
                                              :svgClasses="['h-5 w-5 stroke-current', textColor]"></feather-icon>
        ...
        <div class="bookmark-container">
            <feather-icon icon="StarIcon" :svgClasses="['stoke-current text-warning', textColor]"
