...
<template>
	<div id="sidebar-demo">
		...
		<div class="main-menu" v-bind:style="{ animationName: animacao }">
			...
			<img
				src="@/assets/images/sidebar/seta-direita.svg"
				class="seta"
				v-if="!menuAtivo"
			/>
			<vs-icon
			...
			<div class="header-sidebar" slot="header">
				<div class="text-center">
					<img
						src="@/assets/images/sidebar/logo-1.png"
						alt=""
						class="logo"
						v-if="menuAtivo"
					/>
			...
			<div class="clickavel" @click="ativarMenu(false)">
				<img
					src="@/assets/images/sidebar/seta-menu-esquerda.svg"
					class="seta-menu"
					v-if="menuAtivo"
				/>
				<img
					src="@/assets/images/sidebar/menu-voltar.svg"
					class="menu-icon"
					v-if="menuAtivo"
				/>
			</div>
			<div class="clickavel" @click="ativarMenu(true)">
				<img
					src="@/assets/images/sidebar/seta-menu-direita.svg"
					class="seta-menu"
					v-if="!menuAtivo"
				/>
				<img
					src="@/assets/images/sidebar/menu-abrir.svg"
					class="menu-icon menu-icon-abrir"
					v-if="!menuAtivo"
				/>
			</div>
		</div>
