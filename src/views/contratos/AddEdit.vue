        ...
        <transition name="fade">
            <footer-doug>
                <div class="vx-col sm:w-11/12 mb-2">
                    <vs-button class="float-right mr-3" color="dark" type="border" icon-pack="feather" icon="x-circle" @click="$router.push({name: 'contratos'})">Cancelar</vs-button>
                    <vs-button icon-pack="material-icons" icon="directions_bus" class="float-right mr-3" color="dark" type="border" @click="configurar" v-if="item.id">Configurar formas de frete</vs-button>
                    <vs-button class="float-right mr-3" color="primary" type="filled" @click="updateEmpresa" v-if="item.id">Salvar</vs-button>
                    <vs-button class="float-right mr-3" color="primary" type="filled" @click="salvarEmpresa" v-else>Salvar</vs-button>
                </div>
            </footer-doug>
        </transition>
        <vs-prompt
