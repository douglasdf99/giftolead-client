    ...
    <div id="simple-calendar-app">
        ...
        <vs-prompt
            ...
            <div class="my-4">
                ...
                <datepicker :language="$vs.rtl ? langHe : langPtBr" :disabledDates="disabledDatesFrom" name="start-date" v-model="startDate"></datepicker>
            </div>
            <div class="my-4">
                <small class="date-label">End Date</small>
                <datepicker :language="$vs.rtl ? langHe : langPtBr" :disabledDates="disabledDatesTo" name="end-date" v-model="endDate"></datepicker>
            </div>
