<template>
	<div>
		...
		<div class="" v-else>
			<vs-table :data="items" class="table-items" v-if="tipo == 'usuario'">
				<template slot="thead">
					<vs-th></vs-th>
					<vs-th></vs-th>
					<vs-th></vs-th>
					...
					<vs-tr :key="indextr" v-for="(tr, indextr) in data" :data="tr">
						<vs-td class="flex items-center">
							<div class="flex items-center">
								<img :src="get_img_cdn(tr.avatar)" width="40px" class="rounded-full mx-5" style="margin-left: -8%"/>
					...
					<vs-tr :key="indextr" v-for="(tr, indextr) in data" :data="tr">
						...
						<vs-td>
							<div class="flex items-center" v-if="tr.user">
								<vs-avatar color="primary" size="40px" :text="tr.user.name" />
						...
						<vs-td>
							<div class="flex items-center">
								...
								<vs-avatar v-else-if="tr.origem" color="primary" size="40px" :text="tr.origem.name" />
								<div class="">
									<label class="" style="font-size: 10px" v-if="tr.origem_type == 'App\\Models\\User'">
										Ticketcriado por:
									</label>
