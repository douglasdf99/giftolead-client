...
<template>
    <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary"
            ...
            <div class="p-10">
                <div class="vx-row">
                    <div class="vx-col w-full mb-5">
                        <span class="font-bold mb-3 ml-2 text-lg">Imagens</span>
                        <div style="width: 100%;     margin-top: 4px;" @dragenter="OnDragEnter" @dragleave="OnDragLeave" @dragover.prevent @drop="onDrop" :class="{ dragging: isDragging }">
                            <vx-card class="card-images mb-base" v-show="images.length">
                                <template slot="no-body">
                                    <!-- ITEM IMAGE -->
                                    <div class="item-img-container bg-white h-64 flex items-center justify-center mb-8 cursor-pointer lg:w-1/3 w-full"
                                         v-for="(image, index) in images" :key="index">
                                        <img :src="image" style="max-width: 200px" alt="logotipo" class="grid-view-img px-4">
                                    </div>
        ...
        <div class="flex flex-wrap items-center p-6" slot="footer">
            <vs-button class="mr-6 font-bold text-white" color="primary" @click="salvar">
                Salvar
            </vs-button>
        </div>
    </vs-sidebar>
