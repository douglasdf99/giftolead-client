            ...
            <div class="p-10">
                ...
                <div class="vx-row contained-example-container mt-10">
                    <div class="vx-col w-full vs-con-loading__container text-center" id="div-with-loading">
                        <vs-button color="primary" outline size="large" class="text-white font-bold" @click="redirectUrl('https://www.melhorrastreio.com.br/rastreio/' + data.rastreio_melhor_envio)">
