        ...
        <transition name="fade" v-if="selecteds.length > 0">
            <footer-doug>
                ...
                <div class="vx-col sm:w-9/12 mb-2">
                    <vs-button id="button-with-loading-fecharPlp" class="float-right mr-3 vs-con-loading__container" color="primary" type="filled" @click="$emit('fecharVarias', selecteds, 'fechar', tipo)"
