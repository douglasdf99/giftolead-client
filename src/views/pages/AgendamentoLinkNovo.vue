                            ...
                            <div class="vx-card__body center">
                                <vs-row>
                                    <vs-col vs-offset="2" vs-type="flex" vs-justify="center" vs-align="center"
                                            vs-w="8">
                                        <h4 class="mb-2 text-center">Nos diga qual o melhor dia e horário para que possamos entrar em contato</h4>
                                    </vs-col>
                                </vs-row>
                                <div class="flex justify-between flex-wrap mt-6 ">
                                    ...
                                    <button @click="salvar()" class="my-6 cursor-pointer" type="button">Enviar</button>
                                    <div class="powerby">
                                        <h4>Power By</h4>
                        ...
                        <div class="vx-card__collapsible-content vs-con-loading__container">
                            <div class="vx-card__body center">
                                ...
                                <vs-row>
                                    <vs-col vs-offset="2" vs-type="flex" vs-justify="center" vs-align="center"
                                            vs-w="8">
                                        <h4 class="mb-10 text-center">Obrigado pelo contato! Nós te ligaremos no dia {{ diaformated }} ás
                                            {{ horaSelecionada }}</h4>
                                    </vs-col>
                                </vs-row>
