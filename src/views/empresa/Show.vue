<template>
    <div>
        <h4 class="font-bold mt-20 mb-10">Informações sobre a empresa</h4>
            ...
            <div class="vx-col sm:w-2/3 w-full mb-2">
                ...
                <div class="vx-row mb-6">
                    <div class="vx-col w-full mb-2">
                        ...
                        <vs-input class="w-full " v-validate="'required'" name="site" v-model="empresa.site"
                                  size="large"/>
                        ...
                        <vx-card class="grid-view-item mb-base overflow-hidden" v-if="empresa.logo && !images.length">
                            <template slot="no-body">
                                ...
                                <div class="item-img-container bg-white h-64 flex items-center justify-center mb-4 cursor-pointer">
                                    <img :src="url_api(empresa.logo)" style="width: 200px" alt="logotipo"
            ...
            <div class="vx-col w-full mb-2">
                ...
                <div class="vx-row mb-6">
                    <div class="vx-col w-full mb-2">
                        ...
                        <span class="text-danger text-sm"
                              v-show="errors.has('rodape')">{{ errors.first('rodape') }}</span>
