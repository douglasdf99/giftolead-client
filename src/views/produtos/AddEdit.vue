  ...
  <div>
    ...
    <div class="vx-row mb-6">
      ...
      <div class="vx-col w-full xlg:w-3/12 lg:w-3/12">
        ...
        <vs-input class="w-full" v-validate="'required'" v-model="produto.cod_produto"
    ...
    <vx class="vx-row mb-20">
      ...
      <div class="vx-col w-full">
        <ul class="clearfix">
          ...
          <li class="w-10 cursor-pointer h-10 rounded-lg m-2 float-left"  :style="{backgroundColor: customcor}" @click="selecionaCor(customcor)" >
            <vs-icon icon="done" icon-pack="material-icons" style="color: white;font-size: 2.5rem;"
                       v-if="produto.cor === customcor" ></vs-icon>
          </li>
          <li class="w-10 cursor-pointer h-10 rounded-lg m-2 float-left">
            <input type="color" v-model="customcor" @change="selecionaCor()" class="w-10 cursor-pointer h-10 rounded-lg ">
          </li>
        </ul>
