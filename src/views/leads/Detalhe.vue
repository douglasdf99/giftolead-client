              ...
              <div class="vx-col w-full lg:w-6/12">
                ...
                <div class="vx-row">
                  <div class="vx-col w-9/12" v-if="lead.id">
                    <VuePhoneNumberInput name="telefone" id="phoneNumber2" v-model="lead.telefone" :translations="translations" no-flags required no-use-browser-locale
                                         clearable :border-radius="8" show-code-on-list @update="onUpdate" v-validate="'required'" :default-country-code="countryAbbr"/>
                  </div>
                </div>
              </div>
              <div class="vx-col w-full lg:w-6/12">
