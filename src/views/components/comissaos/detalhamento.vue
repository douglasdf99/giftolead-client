				...
				<div class="vx-row mb-5">
					<div class="vx-col w-1/2">
						<div class="flex items-center">
							<img :src="get_img_cdn(data.avatar)" width="50px" class="rounded-full mx-5"
								  style="margin-left: -8%"/>
						...
						<vs-table :data="data.comissaos" class="table-items">
							...
							<template slot-scope="{data}">
								<vs-tr :key="indextr" v-for="(tr, indextr) in data" :data="tr"
										 v-bind:class="{'row-table-disabled': true}">
									<vs-td>
									...
									<vs-td>
										<div class="" v-if="tr.origem">
											<vx-tooltip delay=".5s" :text="tr.origem.nome">
												<img src="@/assets/images/util/checkout.svg" width="40" class="ml-4 rounded-full"
													  v-if="tr.origem_type == 'App\\Models\\CampanhaCarrinho'">
											</vx-tooltip>
											<vx-tooltip delay=".5s" :text="tr.origem.nome">
												<img src="@/assets/images/util/boleto.svg" width="40" class="ml-4 rounded-full"
													  v-if="tr.origem_type == 'App\\Models\\CampanhaBoleto'">
											</vx-tooltip>
											<vx-tooltip delay=".5s" :text="tr.origem.nome">
												<img src="@/assets/images/util/whatsapp.svg" width="40" class="ml-4 rounded-full"
													  v-if="tr.origem_type == 'App\\Models\\CampanhaWhatsapp'">
											</vx-tooltip>
											<vx-tooltip delay=".5s" :text="tr.origem.nome">
												<img src="@/assets/images/util/agendamento.svg" width="40" class="ml-4 rounded-full"
													  v-if="tr.origem_type == 'App\\Models\\CampanhaAgendamento'">
											</vx-tooltip>
											<vx-tooltip delay=".5s" :text="tr.origem.nome">
												<img src="@/assets/images/util/cancelado.svg" width="40" class="ml-4 rounded-full"
													  v-if="tr.origem_type == 'App\\Models\\CampanhaCancelado'">
											</vx-tooltip>
											<vx-tooltip delay=".5s" :text="tr.origem.name">
												<img :src="get_img_cdn(tr.origem.avatar)" width="40" class="ml-4 rounded-full"
													  v-if="tr.origem.avatar">
											</vx-tooltip>
										</div>
									</vs-td>
									<vs-td>
