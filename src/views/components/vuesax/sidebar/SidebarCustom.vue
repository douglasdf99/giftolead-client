...
<template>
    <vx-card title="Custom Sidebar" code-toggler>
        ...
        <p>You can also use feather icons in sidebar group and sidebar items using icon property. Check out all feather
            icons <a href="https://vue-feather-icons.netlify.com/" target="_blank" rel="nofollow">here</a></p>

        <p class="mt-3">Main sidebar on left side is demo of Custom Sidebar. You can check full code by clicking on
            code-toggler icon of this card.</p>
