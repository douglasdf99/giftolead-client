        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full lg:w-1/3 p1-1">
                <div class="w-full bg-white p-5 rounded-lg h-full">
                    <h3 class="font-bold">Plano Atual : Standard</h3>
                    <div class="vx-row my-4 flex justify-between">
                        ...
                        <div class="vx-col w-full lg:w-1/2">
                            <p class="text-lg font-semibold text-right my-4" style="color: #9B9B9B">
                                Utilizado / Maximo
                            </p>
                            <p class="text-black text-xl text-right">
                                10
                            </p>
                            <p class="text-black text-xl text-right">
                                10
