    ...
    export default {
                ...
                this.$validator.validateAll().then(result => {
                    if (result) {
                        ...
                        if (this.motivo.id !== null && this.motivo.id >= 0) {
                            obj._method = 'PUT';
                            this.$store.dispatch("updateItem", {rota: 'tipo_de_perdas', item: obj}).then(() => {
                                this.$vs.notify({
                                    title: 'Sucesso',
                                    text: "O motivo foi atualizado com sucesso.",
                                    iconPack: 'feather',
                            ...
                            this.$store.dispatch("addItem", {rota: 'tipo_de_perdas', item: obj}).then(() => {
                                this.$vs.notify({
                                    title: 'Sucesso',
                                    text: "O motivo foi criado com sucesso.",
                                    iconPack: 'feather',
                                    icon: 'icon-check-circle',
                                    color: 'success'
                                })
        ...
        created() {
            ...
            if (Object.entries(this.data).length === 0) {
                ...
                //this.selected.label = this.motivo.integracao.descricao;
