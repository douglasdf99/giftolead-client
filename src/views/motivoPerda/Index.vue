<template>
    <div>
        ...
        <div class="vx-row flex items-center lg:mt-20 sm:mt-6">
            <div class="vx-col w-full sm:w-0 md:w-0 lg:w-6/12 xlg:w-5/12 col-btn-incluir-mobile mb-3" v-if="$acl.check('configuracao_perda_incluir')">
            ...
            <div class="vx-col w-full lg:w-6/12 xlg:w-5/12 col-btn-incluir-desktop" v-if="$acl.check('configuracao_perda_incluir')">
                <vs-button color="primary" class="float-right botao-incluir" type="filled" @click="addNewData">
                    <vs-icon icon-pack="material-icons" icon="check_circle" class="icon-grande"></vs-icon>
                    Incluir Motivo
                </vs-button>
                    ...
                    <div class="w-full lg:w-6/12 xlg:w-6/12 s:w-full sem-item">
                        <div class="w-8/12">
                            <div v-if="dados.search">
                                ...
                                <p class="text-sem-item mt-6" v-if="$acl.check('configuracao_perda_incluir')">
                            ...
                            <div v-else>
                                ...
                                <p class="text-sem-item" v-if="$acl.check('configuracao_perda_incluir')">
                                    Para inserir novos registros você <br> pode clicar em incluir conta.
                                </p>
                            </div>
                            <br>
                            <p v-if="$acl.check('configuracao_perda_incluir')">
                        ...
                        <template slot-scope="{data}">
                            <vs-tr :key="indextr" v-for="(tr, indextr) in data" class="mb-3 relative">
                                <vs-td class="flex justify-center items-center relative w-full">
                                    <vs-dropdown vs-trigger-click v-if="$acl.check('configuracao_perda_editar') || $acl.check('configuracao_perda_delete')">
                                        ...
                                        <vs-dropdown-menu class="dropdown-menu-list">
                                            ...
                                            <vs-dropdown-item @click="updateData(data[indextr])" v-if="$acl.check('configuracao_perda_editar')">
                                                <vs-icon icon-pack="material-icons" icon="create"></vs-icon>
                                                Editar
                                            </vs-dropdown-item>

                                            <vs-dropdown-item @click="deletar(data[indextr].id)" v-if="$acl.check('configuracao_perda_delete')">
