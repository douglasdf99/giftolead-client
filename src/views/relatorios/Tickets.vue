...
<script>
import LineChart from "./vendas/LineChart";
import Coorecuperados from './vendas/Coorecuperados';
import Automaticas from './vendas/Automaticas';
import CustomStatisticsCard from './vendas/CustomStatisticsCard';
...
export default {
    ...
    components: {
        RelHeader,
        MetodosPagamento,
        LineChart, CustomStatisticsCard, Coorecuperados, Automaticas},
    data() {
        return {
            dados: {
                route: 'relatorio-tickets',
                mutation: 'SET_REL_TICKETS',
                dt_inicio: '',
                dt_fim: '',
                produtos: [],
                daysInterval: 7
