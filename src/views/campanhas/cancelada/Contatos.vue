<template>
  <div>
    ...
    <div class="vx-row flex items-end mb-4">
      ...
      <div class="vx-col w-full lg:w-3/12 sm:w-full" v-if="$route.name == 'campanha-config-canceladas-contatos-todos'">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if (this.$route.name === 'campanha-config-canceladas-contatos-todos') {
        this.dados.todos = '1';
      }
