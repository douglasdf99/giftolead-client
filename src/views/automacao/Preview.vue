<template>
    <div>
        ...
        <body>
        <center class="wrapper" data-link-color="#7f0099" data-body-style="font-size:16px; font-family:verdana,geneva,sans-serif; color:#516775; background-color:#ececec;">
          <div class="webkit">
                          ...
                          <tr>
                            <td>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px;" align="center">
                                <tr>
                                  <td role="modules-container" style="padding:0px 0px 0px 0px; color:#516775; text-align:left;" bgcolor="#ffffff" width="100%" align="left">
                                    <table class="module preheader preheader-hide" role="module" data-type="preheader" border="0" cellpadding="0" cellspacing="0" width="100%"
                                           style="display: none !important; mso-hide: all; visibility: hidden; opacity: 0; color: transparent; height: 0; width: 0;">
                                      <tr>
                                        <td role="module-content">
                                          <p>trago boas noticias.</p>
                                        </td>
                                      </tr>
                                    </table>
                                      ...
                                      <tr>
                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                                          <img class="max-width" border="0"
                                               ...
                                               src="https://saveleads.com.br/images/we.jpg" alt="" width="600" data-responsive="true" data-proportionally-constrained="false">
                                        </td>
                                      </tr>
                                      </tbody>
                                    </table>
                                    <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;"
                                      ...
                                      <tbody>
                                      <tr>
                                        <td style="background-color:#ffffff; padding:50px 20px 10px 20px; line-height:30px; text-align:inherit;" height="100%" valign="top" bgcolor="#ffffff">
                                          <div>
                                            <div style="font-family: inherit; text-align: left"><span
                                              style="color: #516775; font-size: 28px; font-family: arial, helvetica, sans-serif"><strong>Boas notícias!</strong></span></div>
                                            <div></div>
                                          </div>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td align="center" class="outer-td" style="padding:0px 0px 0px 0px; background-color:#ffffff;" bgcolor="#ffffff">
                                          <table border="0" cellpadding="0" cellspacing="0" class="button-css__deep-table___2OZyb wrapper-mobile" style="text-align:center">
                                            <tbody>
                                            <tr>
                                              <td align="center" bgcolor="#00C2B7" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;"><a
                                                ...
                                                href="https://weentrega.saveleads.com.br/preencher/" target="_blank">0000000000</a></td>
                                            </tr>
                                            </tbody>
                                          </table>
                                        </td>
                                    ...
                                    <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;"
                                      ...
                                      <tbody>
                                      <tr>
                                        <td style="padding:10px 40px 50px 40px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff"
                                            role="module-content">
                                          <div>
                                            ...
                                            <div style="font-family: inherit; text-align: inherit"><br></div>
                                            <div style="font-family: inherit; text-align: inherit"><br></div>
                                            <div style="font-family: inherit; text-align: inherit"><strong>Sistema parceiro</strong></div>
                                            <div style="font-family: inherit; text-align: inherit"><strong>WeEntregas</strong></div>
                                            <div></div>
                                          </div>
                                        </td>
                                      </tr>
