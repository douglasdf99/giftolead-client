                                                                        ...
                                                                        <tr>
                                                                            <td role="modules-container" style="padding:0px 0px 0px 0px; color:#516775; text-align:left;" bgcolor="#ffffff" width="100%" align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                                                                                            <img class="max-width" border="0"
                                                                                                 ...
                                                                                                 src="https://saveleads.com.br/images/we.jpg" alt="" width="600" data-responsive="true"
                                                                                ...
                                                                                <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;"
                                                                                    ...
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td style="background-color:#ffffff; padding:10px 40px 5px 40px; line-height:22px; text-align:inherit;" height="100%" valign="top"
                                                                                            bgcolor="#ffffff">
                                                                                            <div v-html="text"></div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="outer-td" style="padding:0px 0px 0px 0px; background-color:#ffffff;" bgcolor="#ffffff">
                                                                                            <table border="0" cellpadding="0" cellspacing="0" class="button-css__deep-table___2OZyb wrapper-mobile"
                                                                                                ...
                                                                                                <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" bgcolor="#00C2B7" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                                                        <a style="background-color:#00C2B7; border:1px solid #00C2B7; border-color:#00C2B7; border-radius:10px; border-width:1px; color:#ffffff; display:inline-block; font-family:verdana,geneva,sans-serif; font-size:16px; font-weight:bold; letter-spacing:1px; line-height:30px; padding:12px 20px 12px 20px; text-align:center; text-decoration:none; border-style:solid;"
                                                                                                            target="_blank">XX0000000XXX</a></td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
                                                                                        ...
                                                                                        <td style="padding:10px 40px 50px 40px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: inherit"><br>
                                                                                                    Você pode rastrear clicando no botão pelo weentrega ou diretamente pelo site dos correios. Caso ainda não tenha a
                                                                                                    informação disponível, aguarde algumas horas ou até um dia útil e
                                                                                                    tente novamente.
                                                                                                </div>
                                                                                ...
                                                                                <div data-role="module-unsubscribe" class="module unsubscribe-css__unsubscribe___2CDlR" role="module" data-type="unsubscribe"
                                                                                    ...
                                                                                    <p style="font-family:arial,helvetica,sans-serif; font-size:12px; line-height:20px;"><a class="Unsubscribe--unsubscribeLink" href=""
                                                                                                                                                                            style="">Unsubscribe</a>
                                                                                    </p></div>
                                                                            </td>
                                                                        </tr>
