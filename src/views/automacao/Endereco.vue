        ...
        <div class="p-6 pt-0">
          ...
          <form class="w-full px-6">
            <div class="flex flex-col">
              ...
              <vs-input class="w-full vs-input-shadow-drop vs-input-no-border d-theme-input-dark-bg mb-3" v-model="endereco.nome" type="text" required/>
            </div>
          ...
          <form class="w-full px-6 vs-con-loading__container" id="div-with-loading">
            ...
            <vs-button class="border-none bg-primary hover:bg-black text-white cursor-pointer font-bold py-2 px-4 rounded-lg w-full h-16 text-2xl my-4" @click="buscaCep" v-if="!valido" type="button">
              Buscar
            </vs-button>
            ...
            <div class="" v-if="valido">
              <div class="vx-row mt-2">
                ...
                <div class="vx-col w-6/12">
                  ...
                  <vs-input class="w-full vs-input-shadow-drop vs-input-no-border d-theme-input-dark-bg mb-3" type="text" required v-model="endereco.numero" name="numero" v-validate="'max:5'"/>
