                        ...
                        <template slot-scope="{data}">
                            <vs-tr :key="indextr" v-for="(tr, indextr) in data" class="mb-3 relative">
                                <vs-td class="flex justify-center items-center relative w-full">
                                    <vs-dropdown vs-trigger-click v-if="$acl.check('configuracao_origem_editar') || $acl.check('configuracao_origem_delete')">
                                        ...
                                        <vs-dropdown-menu class="dropdown-menu-list">
                                            ...
                                            <vs-dropdown-item @click="deletar(data[indextr].id)" v-if="$acl.check('configuracao_origem_delete')">
