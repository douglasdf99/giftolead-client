					...
					<vs-table :data="items" class="table-items" style="border-spacing: 0 8px;border-collapse: separate;">
						...
						<template slot-scope="{data}">
							<vs-tr :key="indextr" v-for="(tr, indextr) in data" class="mb-3 relative">
								<vs-td class="flex justify-center items-center relative w-full" v-if="tr.company_id">
									<vs-dropdown vs-trigger-click v-show="tr.company_id" v-if="$acl.check('configuracao_origem_editar') || $acl.check('configuracao_origem_deletar')">
