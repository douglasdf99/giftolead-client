            ...
            <div class="flex mb-4 items-center justify-center">
              <div class="w-1/3 p-10 ">
                <vx-card class="items-center cursor-pointer card-option" :class="{'border-primary' : brinde.contrato_type == 'App\\Models\\Correio'}" @click="brinde.contrato_type = 'App\\Models\\Correio'">
                  <div slot="no-body">
                    <div class="p-4">
                      <img src="@/assets/images/util/correios.svg" class="mx-auto rounded-full w-full" alt="" >
                    </div>
              ...
              <div class="w-1/3 p-10">
                <vx-card class="items-center card-option" :class="{'border-primary' : brinde.contrato_type == 'App\\Models\\Extensoes\\MelhorEnvio'}" @click="brinde.contrato_type = 'App\\Models\\Extensoes\\MelhorEnvio'">
                  <div slot="no-body">
                    <div class="p-4">
                      <img src="@/assets/images/util/melhorenvio2.png" class="mx-auto rounded-full w-full" alt="100%" >
                    </div>
                    <div class="mx-auto flex">
