  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary"
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :key="$vs.rtl">
      <div class="p-6">
        ...
        <vs-input size="large " v-validate="'required'" label="Nome da brinde" autocomplete="off" v-model="brinde.nome"
                  class="mt-5 w-full"
                  name="nome"/>
        ...
        <div class="" v-if="!brinde.hasembalagem">
          ...
          <div class="vx-row">
            <div class="vx-col  w-full mb-2">
              ...
              <v-select v-model="brinde.tipoDeCaixa" :class="'select-large-base'" :clearable="false" :options="opcoesTipoCaixa"
            ...
            <div class="vx-col sm:w-1/2 w-full mb-2">
              <vs-input size="large " v-validate="'required'" label="Altura" autocomplete="off" v-model="brinde.altura"
                        class="mt-5 w-full"
                        name="altura"/>
          ...
          <div class="vx-row ">
            ...
            <div class="vx-col sm:w-1/2 w-full mb-2">
              <vs-input size="large " v-validate="'required'" label="Peso" autocomplete="off" v-model="brinde.peso"
                        class="mt-5 w-full"
                        name="peso"/>
        ...
        <div class="mt-4" v-if="brinde.hasembalagem">
          ...
          <v-select v-model="embalagem" :class="'select-large-base'" :clearable="false" :options="opcoesEmbalagem"
                    v-validate="'required'" name="embalagem"/>
          <span class="text-danger text-sm" v-show="errors.has('embalagem')">{{ errors.first('embalagem') }}</span>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        opcoesTipoCaixa: [{id: '001', label: 'TIPO ENVELOPE'}, {id: '002', label: 'TIPO PACOTE CAIXA'},{id: '003', label: 'TIPO ROLO CILINDRO'}],
