                        ...
                        <template slot-scope="{data}">
                            <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                                <vs-td class="flex justify-center items-center">
                                    <vs-dropdown vs-trigger-click v-if="$acl.check('configuracao_brinde_editar') || $acl.check('configuracao_brinde_delete')">
                                        ...
                                        <vs-dropdown-menu class="dropdown-menu-list">
                                            ...
                                            <vs-dropdown-item @click="deletar(data[indextr].id)" v-if="$acl.check('configuracao_brinde_delete')">
