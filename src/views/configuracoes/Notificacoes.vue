  ...
  <div class="vx-row" v-if="dados">
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Atividades" subtitle="Notificações relacionadas ao usuário" no-shadow>
        ...
        <option-notification class="w-full" :option.sync="dados.funcao_alterada_para" :option="dados.funcao_alterada_para"></option-notification>
      </vx-card>
    </div>
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Brinde" subtitle="Notificações relacionadas a brindes" no-shadow>
        ...
        <option-notification class="w-full" :option.sync="dados.solicitacao_brinde_foi_aprovada" ></option-notification>
      </vx-card>
    </div>
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Ordem" subtitle="Notificações relacionadas a ordens" no-shadow>
        <span class="font-bold">Ordem Paga</span>
        <option-notification class="w-full" :option.sync="dados.ordem_paga" ></option-notification>
      </vx-card>
    </div>
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Comissão" subtitle="Notificações relacionadas a comissãos" no-shadow>
        ...
        <option-notification class="w-full" :option.sync="dados.comissao_aprovada" ></option-notification>
      </vx-card>
    </div>
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Conquista" subtitle="Notificações relacionadas a conquista" no-shadow>
        ...
        <option-notification class="w-full" :option.sync="dados.conquista_alcancada" ></option-notification>
      </vx-card>
    </div>
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Correio" subtitle="Notificações relacionadas a conquista" no-shadow>
        ...
        <option-notification class="w-full" :option.sync="dados.contrato_correios_inativo" ></option-notification>
      </vx-card>
    </div>
    ...
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Ticket" subtitle="Notificações relacionadas a tickets" no-shadow>
        ...
        <option-notification :option.sync="dados.ticket_foi_atendido" ></option-notification>
      </vx-card>
    </div>
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
      <vx-card title="Zenvia" subtitle="Notificações relacionadas a zenvia" no-shadow>
        <span class="font-bold">Recarga Zenvia</span>
        <option-notification :option.sync="dados.recarga_zenvia" ></option-notification>

        <span class="font-bold">Saldo zenvia baixo</span>
        <option-notification :option.sync="dados.saldo_zenvia_baixo" ></option-notification>

        <span class="font-bold">Sem saldo zenvia</span>
        <option-notification :option.sync="dados.sem_saldo_zenvia" ></option-notification>

        <span class="font-bold">Ramal foi vinvulado</span>
        <option-notification :option.sync="dados.ramal_vinculado" ></option-notification>

        <span class="font-bold">Ramal alterado</span>
        <option-notification :option.sync="dados.ramal_alterado" ></option-notification>

        <span class="font-bold">Ramal devinculado</span>
        <option-notification :option.sync="dados.ramal_devinculado" ></option-notification>
      </vx-card>
    </div>
  </div>
