    ...
    <transition name="fade">
      <footer-doug>
        <div class="vx-col sm:w-11/12 mb-2">
          <vs-button class="float-right ml-4 mt-2" type="border" color="warning" @click="calcelar">Cancelar</vs-button>
          <vs-button class="float-right mt-2" @click="update">Salvar alterações</vs-button>
        </div>
      </footer-doug>
    </transition>
  </div>
